...
class Cube{
	 ...
	 * @param UV|Vector2|null   $uv      An object or specifies the upper-left corner on the texture for the start of the texture mapping for this box.
	 ...
	 * @param bool         $mirror Mirrors this cube about the un-rotated x-axis (effectively flipping the east / west faces), overriding the bone's 'mirror' setting for this cube.
	 */
	public function __construct(
		...
		public UV|Vector2|null $uv = null,
	) {}
